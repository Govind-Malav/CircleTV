    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-950">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Sign in to your CircleTV account</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 disabled:opacity-50 text-white font-semibold rounded-xl transition-all shadow-lg shadow-violet-500/25"
            >
              {loading ? (
                <>
